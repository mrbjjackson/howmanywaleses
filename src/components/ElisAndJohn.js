    ...
    return (
        <div className="elisAndJohn">
            <div className="thoughtBubble">
                ...
                <p><strong>How Many Waleses?</strong> is a game that featured on the "Made Up Games" feature on the Elis James and John Robins BBC 5Live radio show <a href="https://www.bbc.co.uk/sounds/play/m0009t88" target="_blank" rel="noopener noreferrer">(1hr15mins into this episode).</a></p>
